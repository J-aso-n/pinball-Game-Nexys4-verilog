...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivado_16.2/projects/big_project/big_project.cache/ip [current_project]
  set_property ip_output_repo d:/vivado_16.2/projects/big_project/big_project.cache/ip [current_project]
  add_files -quiet D:/vivado_16.2/projects/big_project/big_project.runs/synth_1/main.dcp
